import{_ as s,o as n,c as p,a5 as e}from"./chunks/framework.Bt0SrEfo.js";const g=JSON.parse('{"title":"网络面试高频 Q&A","description":"","frontmatter":{},"headers":[],"relativePath":"网络/18-interview-qa.md","filePath":"网络/18-interview-qa.md","lastUpdated":1790086012000}'),l={name:"网络/18-interview-qa.md"};function t(i,a,o,r,c,h){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="网络面试高频-q-a" tabindex="-1">网络面试高频 Q&amp;A <a class="header-anchor" href="#网络面试高频-q-a" aria-label="Permalink to &quot;网络面试高频 Q&amp;A&quot;">​</a></h1><h2 id="一、http-基础" tabindex="-1">一、HTTP 基础 <a class="header-anchor" href="#一、http-基础" aria-label="Permalink to &quot;一、HTTP 基础&quot;">​</a></h2><h3 id="q1-http-和-https-的区别" tabindex="-1">Q1:HTTP 和 HTTPS 的区别? <a class="header-anchor" href="#q1-http-和-https-的区别" aria-label="Permalink to &quot;Q1:HTTP 和 HTTPS 的区别?&quot;">​</a></h3><p><strong>答</strong>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>HTTP:明文传输,80 端口</span></span>
